...
class SemBoxRasterizerWithRawData:
    def __init__(
        self,
...
class SemBoxRasterizer(SemBoxRasterizerWithRawData, Rasterizer):
    ...
    def __init__(
        ...
        super(SemBoxRasterizer, self).__init__(render_context, filter_agents_threshold, history_num_frames, semantic_map_path, world_to_ecef)
